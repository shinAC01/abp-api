...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3342d6c9-3d00-4900-8f0d-eeb6d8bafdd5
```

> `3342d6c9-3d00-4900-8f0d-eeb6d8bafdd5` is the password of the certificate, you can change it to any password you want.
